...
After collection, open **Tools → AI Artifacts → Collect AI Artifacts** and choose the KAPE output, triage root, mounted disk, or copied profile folder. IRFlow walks Windows, Linux, and macOS profile layouts and merges discovered AI history into one **AI Query History** tab.
:::
